...
class NewStudentVC: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func femaleAttBtnPressed(_ sender: Any) {
        if !attributes[0] {
            femaleAttBtn.titleLabel?.textColor = UIColor.white
            femaleAttBtn.backgroundColor = UIColor.gray
            attributes[0] = true
        } else {
            femaleAttBtn.titleLabel?.textColor = UIColor.blue
    ...
    @IBAction func Att1BtnPressed(_ sender: Any) {
        if !attributes[1] {
            Att1Btn.titleLabel?.textColor = UIColor.white
            Att1Btn.backgroundColor = UIColor.gray
            attributes[1] = true
        } else {
            Att1Btn.titleLabel?.textColor = UIColor.blue
    ...
    @IBAction func Att2BtnPressed(_ sender: Any) {
        if !attributes[2] {
            Att2Btn.titleLabel?.textColor = UIColor.white
            Att2Btn.backgroundColor = UIColor.gray
            attributes[2] = true
        } else {
            Att2Btn.titleLabel?.textColor = UIColor.blue
    ...
    @IBAction func Att3BtnPressed(_ sender: Any) {
        if !attributes[3] {
            Att3Btn.titleLabel?.textColor = UIColor.white
            Att3Btn.backgroundColor = UIColor.gray
            attributes[3] = true
        } else {
            Att3Btn.titleLabel?.textColor = UIColor.blue
    ...
    @IBAction func addStudentBtnPressed(_ sender: Any) {
        ...
        if (firstNameTF.text != "" && lastNameTF.text != "") {
            ...
            studentRef.updateChildValues(["firstName": firstNameTF.text!, "lastName": lastNameTF.text!, "weekCount": 0, "monthCount": 0, "totalCount": 0, "attributes" : attHash, "hasPass": false])
